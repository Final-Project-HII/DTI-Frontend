    ...
    <div className="flex justify-center items-center pt-10 pb-20">
      <div className="w-4/5 max-w-[400px] bg-white p-6 rounded-lg shadow-md lg:w-full">
        ...
        <button className="flex items-center justify-center w-full border border-gray-300 rounded-md p-2 hover:bg-gray-50 transition duration-300">
          <Image
            ...
            className="mr-2"
          />
          <span className="text-gray-700 text-sm" onClick={handleGoogleSignUp}>
      ...
      {isRegistered && (
        <Modal
          ...
          description=" A verification link has been sent to your email. Please check your inbox to verify your account."
        />
      )}
      {emailExist && (
        <Modal
          title="Email Has Already Been Registered!"
          description="Please input another email for registration."
        />
      )}
    </div>
  );
