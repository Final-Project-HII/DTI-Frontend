...
const ResetPasswordForm = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      {isNotVerified ? (
        <GenerateNewVerificationModal
          email={email}
          title="You have not verified your account yet!"
          description="Please verify your account first before you can reset your password."
        />
      ) : (
        <div className="w-4/5 max-w-[400px] bg-white p-6 rounded-lg shadow-md lg:w-full">
          <div className="flex justify-between items-center">
            <div className="flex gap-3 items-center">
              ...
              <h1 className="text-2xl font-bold  text-center z-20">
                Reset Password
              </h1>
            </div>
      ...
      {isSuccessfull && (
        <Modal
          ...
          description="A reset password link has been sent to your email. Please check your inbox to reset your account password."
        />
      )}
      {isNotRegistered && (
        <Modal
          title="Your Account Is Not Registered Yet!"
          description="Please register your account first and verify it first, if you want to reset your password."
        />
      )}
    </div>
  );
